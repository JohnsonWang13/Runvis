//
//  WeatherSecondCellLabel.swift
//  Runvis
//
//  Created by 吳政緯 on 2017/6/1.
//  Copyright © 2017年 吳政緯. All rights reserved.
//

import UIKit

//DetailedWeatherConditionSecondCell那六個污染物UIlabel專用
//字體為PingFangTC-Regular
class WeatherSecondCellLabel:UILabel{
    
    override func awakeFromNib() {
        
        self.font = UIFont(name: "UniversLT-CondensedLight", size: self.font.pointSize)
