...
class MulticolorPolylineSegment: MKPolyline {
    ...
    private class func allSpeeds(forLocations locations: [RunningLocations]) ->
    ...
    class func colorSegments(forLocations locations: [RunningLocations]) -> [MulticolorPolylineSegment] {
